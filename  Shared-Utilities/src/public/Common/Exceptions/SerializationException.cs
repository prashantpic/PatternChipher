...
{
    /// <summary>
    /// Public exception specific to errors encountered during object serialization or deserialization.
    /// </summary>
    /// <remarks>
    /// Signals errors specifically related to serialization or deserialization processes.
    /// </remarks>
    [Serializable]
    public class SerializationException : SharedUtilitiesException
    {
        /// <summary>
